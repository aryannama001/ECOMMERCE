...
const { getAllProducts, createProduct, getProduct, updateProduct, deleteProduct, createProductReview, getAllReviews, deleteReview, featuredProducts } = require('../controllers/productController');
