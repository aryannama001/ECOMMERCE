...
const { createUser, getAllUsers, getUser, loginUser, logoutUser, getProfile, updateProfile, updatePassword, updateUserRole, deleteUser, userContact } = require('../controllers/userController');
...
router.route('/profile').get(authenticateUser, getProfile).put(authenticateUser, updateProfile)
